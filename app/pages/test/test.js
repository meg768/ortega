			...
			<Grid>
				...
				<Row>
					<Col md={6} >
						...
						<Button ref='MEG' onClick={this.onMEG.bind(this)}>MEG</Button>
						<Button ref='JBN'>JBN</Button>
					</Col>
				</Row>

				<Row>
					<Col md={6}>
						<Input type='checkbox' ref='checkbox' label='This is a checkbox' onChange={this.onCheckboxChanged.bind(this, 'checkbox')}/>
					</Col>
					<Col md={6}>
						<Input type='checkbox' label='Another checkbox' onChange={this.onEvent.bind(this, 'checkBoxClicked')}/>
					</Col>
				</Row>
				<Row>
					<Col md={6} >
