...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultRoute = __webpack_require__(158).DefaultRoute;
	...
	var routes = (  
	  React.createElement(Route, {name: "app", path: "/", handler: App}, 
	  	React.createElement(DefaultRoute, {handler: __webpack_require__(211)}), 
	  	
	    React.createElement(Route, {name: "kalle", path: "/kalle", handler: __webpack_require__(211)})
	    
	  )
	);

	Router.Router.run(routes, function (Handler) {  
